...
function Joingame() {
  ...
  return (
    <div>
      {loading ? (
        <div className="flex h-[100vh] justify-center bg-[#292927] items-center">
          <PuffLoader size={80} color={"white"} loading={loading} />
        </div>
      ) : (
                  ...
                  <div className="container mx-auto flex flex-wrap flex-col md:flex-row items-center justify-between">
                    <div className="flex title-font font-medium items-center  mb-4 md:mb-0">
                      <svg
                        ...
                        height="50"
                        fill="#BDBDBD"
                        className="bi bi-person-fill bg-[#383531]"
                        viewBox="0 0 16 16"
                      >
                        <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3Zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
                      </svg>
                      <span className="ml-3 text-xl text-[#BDBDBD]">
                        Opponent
                      </span>
                    </div>

                    <button className="inline-flex text-[#BDBDBD] items-center bg-[#383531] border-0 py-2 px-3 rounded text-base ">
                      <Timer />
                    </button>
                  </div>
                </header>
